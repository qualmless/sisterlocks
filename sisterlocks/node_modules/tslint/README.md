...
-   [tslint-sonarts](https://github.com/SonarSource/SonarTS) - Bug-finding rules based on advanced code org.launchcode.sisterlocksprofiles.models to spot hard to find errors in TypeScript
